...
def home(request):
 ...
 # vendor fast food
  ...
  vendors_fast_food=Vendor.objects.filter(Q(id__in=fetch_vendors_by_fast_food) | Q(vendor_name__icontains="chicken",is_approved=True,user__is_active=True))
 ...
 # vendor pizza
  ...
  vendors_pizza=Vendor.objects.filter(Q(id__in=fetch_vendors_by_pizza) | Q(vendor_name__icontains="pizza",is_approved=True,user__is_active=True))
 ...
 # vendor hamburger
  ...
  vendors_hamburger=Vendor.objects.filter(Q(id__in=fetch_vendors_by_hamburger) | Q(vendor_name__icontains="hamburger",is_approved=True,user__is_active=True))
 ...
 # vendor drink
  ...
  vendors_drink=Vendor.objects.filter(Q(id__in=fetch_vendors_by_drink) | Q(vendor_name__icontains="drink",is_approved=True,user__is_active=True))
